# Plot2.R. A script to create a line graph of household power consumption
...
# Finally create the  plot as a PNG file 
        png(filename = "plot2.png",width = 480, height = 480) # Set the graphics device to a png file
        with(thedata,plot(Datetime,Global_active_power,type="l",ylab="Global Average Power (kilowatts)"))
